...
document.addEventListener('DOMContentLoaded', function() {
    ...
    displayButton.addEventListener('click', function() {
        ...
        restaurants.forEach((restaurant) => { restaurantList.innerHTML += `<div>${restaurant.name}</div>` })
    ...
    filterButton.addEventListener('click', function() {
        ...
        // YOUR CODE HERE:
        cheapRestaurants.forEach((restaurant) => { filteredList.innerHTML += `<div>${restaurant.name}</div>` })
    ...
    mapButton.addEventListener('click', function() {
        ...
        names.forEach((restaurant) => { mappedList.innerHTML += `<li>${restaurant}</li>` })
        mappedList.innerHTML += `</ul>`
    ...
    findButton.addEventListener('click', function() {
        ...
        foundItem.innerHTML=`${bestRestaurant.name}`
        // YOUR CODE HERE:
